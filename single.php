...
<div class="content">
  <?php echo do_shortcode('[wpcode id="174533"]'); ?>
            ...
            <div class="blog-card-bottom">
              ...
              <div class="entry-content">
                <div class="entry themeform">
                  ...
                  <?php echo do_shortcode('[wpcode id="174537"]'); ?>
                  <!-- add padding to the top of the div -->

                  <div style="padding-top: 20px;">
                    <!-- recomended ad network -->
                    <?php echo do_shortcode('[wpcode id="172546"]'); ?>
                  </div>
